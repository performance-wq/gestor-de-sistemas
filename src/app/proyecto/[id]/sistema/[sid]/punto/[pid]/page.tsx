...
export default function PuntoView() {
  ...
  // Resolver URL firmada de la imagen cuando cambia.
  useEffect(() => {
    let activo = true;
  ...
  // Resolver URL del video: si es un path de storage se firma; si es link, se embebe.
      ...
      <div className="mt-4 flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <div className="mt-1 flex items-center gap-2 text-sm">
            ...
            {punto.fijo && (
              <span className="text-xs text-muted">Punto fijo de plantilla</span>
            )}
          </div>
        </div>
        <button
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        ...
        <section className="rounded-xl border border-border bg-surface p-5 shadow-sm">
          ...
          <textarea
            ...
            placeholder="Escribe aquí el copy de este punto de contacto…"
            rows={14}
